...
**⛔ Absence of annotations ≠ approval.** Annotations are an *optional* inline-comment channel; most users approve verbally via Step 18. Never collapse Step 17 → Step 19 because the file is missing or empty.
...
**If `NO_ANNOTATIONS_FOUND`:** continue to Step 18. **You still MUST run Step 18 (the human gate).**
