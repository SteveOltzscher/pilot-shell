...
`+JSON.stringify(o,null,2):p=" "+this.formatData(o));let m="";if(n){let{sessionId:_,memorySessionId:E,correlationId:O,...g}=n;Object.keys(g).length>0&&(m=` {${Object.entries(g).map(([f,S])=>`${f}=${S}`).join(", ")}}`)}let T=`[${i}] [${a}] [${d}] ${l}${s}${m}${p}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,T+`
...
`):null}function xt(r,e,t,s,n,o){let i=[];o?i.push(...Ke(r)):i.push(...we(r));let a=null,d="",l=!1;for(let p of e)if(p.type==="summary"){l&&(i.push(""),l=!1,a=null,d="");let m=p.data,T=ot(m.displayTime);o?i.push(...Ze(m,T)):i.push(...$e(m,T))}else{let m=p.data,T=dt(m.files_modified,n,m.files_read),_=it(m.created_at),E=_!==d,O=E?_:"";d=_;let g=t.has(m.id);if(T!==a&&(l&&i.push(""),o?i.push(...Je(T)):i.push(...Ue(T)),a=T,l=!0),g){let h=Mt(m,s);o?i.push(...Qe(m,_,E,h,s)):(l&&!o&&(i.push(""),l=!1),i.push(...Fe(m,O,h,s)),a=null)}else o?i.push(ze(m,_,E,s)):i.push(Pe(m,O,s))}return l&&i.push(""),i}function ct(r,e,t,s,n){let o=[],i=Dt(r);for(let[a,d]of i)o.push(...xt(a,d,e,t,s,n));return o}function lt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function pt(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,c.blue)),t.push(...k("Learned",r.learned,c.yellow)),t.push(...k("Completed",r.completed,c.green)),t.push(...k("Next Steps",r.next_steps,c.magenta))):(t.push(...x("Investigated",r.investigated)),t.push(...x("Learned",r.learned)),t.push(...x("Completed",r.completed)),t.push(...x("Next Steps",r.next_steps))),t}function ut(r,e){return e?et(r):je(r)}function mt(r,e,t){return!j(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?tt(r.totalDiscoveryTokens,r.totalReadTokens):Xe(r.totalDiscoveryTokens,r.totalReadTokens)}var kt=_t.default.join((0,Et.homedir)(),".claude","plugins","marketplaces","pilot","plugin",".install-version");function wt(){try{return new $}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,gt.unlinkSync)(kt)}catch(e){u.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return u.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Ut(r,e){return e?st(r):We(r)}function Pt(r,e,t,s,n,o,i){let a=[],d=K(e);a.push(...rt(r,d,s,i));let l=t.slice(0,s.sessionCount),p=Ne(l,t),m=J(e,p),T=Ce(e,s.fullObservationCount);a.push(...ct(m,T,s,n,i));let _=t[0],E=e[0];lt(s,_,E)&&a.push(...pt(_,i));let O=ye(e,s,o,n);return a.push(...ut(O,i)),a.push(...mt(d,s,i)),a.join(`
